...
def index(request: Request) -> Any:
    ...
    body = (
        ...
        "</div>"
        "<div>"
        "The accompanying repository can be seen here: <a href='https://github.com/pprieri/ml/tree/mainbranch/Examples_of_ML_application/house_ml_app' target='_blank'>pprieri/house_ml_app</a>"
        "</div>"
